    ...
    <?php 
        ...
        foreach($products as $product){
            if (trim($product['image']) == null) {
              ...
              <td class='text-center' style='padding-top: 1.9rem'><a href='viewProduct.php?productID=". $product['id'] ."' class='text-decoration-none'>" . htmlspecialchars_decode($product['name']) ." </a></td>
