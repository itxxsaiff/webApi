                ...
                <h2>Basic Info</h2>
                        ...
                        <div class="col-6 mt-3">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <input class="form-check-input ms-3" name="type" type="radio" id="" value="Services">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="product_sku" class="form-control" placeholder="Enter Product SKU">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 mt-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-9">
                                <input type="number" name="product_weight" class="form-control" placeholder="Product Weight">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-1">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-8">
                                <input type="text" name="product_manufacturer" class="form-control" placeholder="Product Manufacturer">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="Price" name="selling_price" required>
                                          </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    ...
                                    <div class="col-8">
                                        <textarea name="selling_desc" id="" cols="20" rows="3" class="form-control"></textarea>
                                          </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-4">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">PKR</span>
                                                <input type="number" class="form-control" placeholder="Selling Tax" name="selling_Tax">
                                              </div>
                                        </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">PKR</span>
                                            <input type="number" class="form-control" placeholder="Cost Price" name="cost_price" required>
                                          </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    ...
                                    <div class="col-8">
                                        <textarea name="cost_desc" id="" cols="20" rows="3" class="form-control"></textarea>
                                          </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-4">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">PKR</span>
                                                <input type="number" class="form-control" placeholder="Cost Tax" name="cost_Tax">
                                              </div>
                                        </div>
                                </div>
                            </div>
                      ...
                      <div class="row mt-4">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-8">
                                    <input type="number" class="form-control" placeholder="Quantity" name="product_Openqty">
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-12">
